// copied http://www.hack-e-bot.com/educators/curriculum-list/using-the-light-sensor/

#include <Servo.h>
 
Servo LServo; //create servo object for the left servo
Servo RServo; //create servo object for the right servo
...
void setup()
{
  LServo.attach(6); // attaches the left servo to pin 1
  RServo.attach(5); // attaches the right servo to pin 0
}
